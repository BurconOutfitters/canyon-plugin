...
class Frontend {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( 'canyon-plugin', plugin_dir_url( __FILE__ ) . 'assets/css/frontend.css', [], CANYON_VERSION, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'canyon-plugin', plugin_dir_url( __FILE__ ) . 'assets/js/frontend.js', [ 'jquery' ], CANYON_VERSION, true );
