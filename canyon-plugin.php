<?php
/**
 * Big Santa Anita Canyon plugin
 *
 * @package     Canyon_Plugin
 * @version     1.0.0
 * @author      Greg Sweet <greg@ccdzine.com>
 * @copyright   Copyright © 2018, Greg Sweet
 * @link        https://github.com/BurconOutfitters/canyon-plugin
 * @link        https://github.com/BurconOutfitters/burcon-plugin
 * @license     GPL-3.0+ http://www.gnu.org/licenses/gpl-3.0.txt
 *
 * Plugin Name: Big Santa Anita Canyon
 * Plugin URI:  https://github.com/BurconOutfitters/canyon-plugin
 * Description: Functionality sepecific to the Big Santa Anita Canyon website.
 * Version:     1.0.0
 * Author:      Controlled Chaos Design
 * Author URI:  http://ccdzine.com/
 * License:     GPL-3.0+
 * License URI: https://www.gnu.org/licenses/gpl.txt
 * Text Domain: canyon-plugin
 ...
 */
if ( ! defined( 'CANYON_PARENT' ) ) {
	define( 'CANYON_PARENT', 'burcon-plugin/burcon-plugin.php' );
}
 ...
 */
if ( ! defined( 'CANYON_PARENT_PREFIX' ) ) {
	define( 'CANYON_PARENT_PREFIX', 'burcon' );
}
 ...
 */
if ( ! defined( 'CANYON_PARENT_NAME' ) ) {
	define( 'CANYON_PARENT_NAME', 'Burcon Outfitters' );
}
 ...
 */
if ( ! defined( 'CANYON_CHILD_NAME' ) ) {
	define( 'CANYON_CHILD_NAME', 'Big Santa Anita Canyon' );
}
 ...
 * @return void
 */
if ( ! is_plugin_active( CANYON_PARENT ) ) {
 ...
 */
if ( ! defined( 'CANYON_VERSION' ) ) {
	define( 'CANYON_VERSION', '1.0.0' );
}
 ...
 */
if ( ! defined( 'CANYON_ADMIN_SLUG' ) ) {
	define( 'CANYON_ADMIN_SLUG', 'canyon-plugin' );
}
 ...
 */
if ( ! defined( 'CANYON_DEFAULT_META_IMAGE' ) ) {
	define(
		'CANYON_DEFAULT_META_IMAGE',
 ...
 * @since  1.0.0
 * @access public
 * @return object Returns the instance of the `Canyon_Plugin` class.
 */
function adams_plugin() {

	return Canyon_Plugin::instance();
 ...
 * @return void
 */
function activate_Canyon_Plugin() {
 ...
 * @return void
 */
function deactivate_Canyon_Plugin() {
 ...
 */
function Canyon_Plugin_about_link( $links ) {

	if ( ! is_network_admin() ) {
		// Create new settings link array as a variable.
		$settings = [
			sprintf(
				'<a href="%1s" class="' . CANYON_ADMIN_SLUG . '-settings-link">%2s</a>',
				admin_url( 'options-general.php?page=' . CANYON_ADMIN_SLUG . '-settings' ),
				esc_attr( 'Settings', 'canyon-plugin' )
			),
		];
...
add_filter( 'plugin_action_links_' . plugin_basename( __FILE__ ), 'Canyon_Plugin_about_link' );